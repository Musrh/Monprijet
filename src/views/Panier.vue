  ...
  <div class="p-4 max-w-3xl mx-auto">
    ...
    <div v-else>
      ...
      <div class="mt-4 space-y-2">
        <label class="font-semibold block">Adresse 1</label>
        <input type="text" v-model="adresse1" class="border p-2 w-full rounded" placeholder="Ex : 123 Rue Exemple" />

        <label class="font-semibold block">Adresse 2</label>
        <input type="text" v-model="adresse2" class="border p-2 w-full rounded" placeholder="Appartement, étage, etc." />

        <label class="font-semibold block">Code Postal</label>
        <input type="text" v-model="codePostal" class="border p-2 w-full rounded" placeholder="Ex : H2K 1E1" />

        <label class="font-semibold block">Ville</label>
        <input type="text" v-model="ville" class="border p-2 w-full rounded" placeholder="Ex : Montréal" />

        <label class="font-semibold block">Pays</label>
        <input type="text" v-model="pays" class="border p-2 w-full rounded" placeholder="Ex : Canada" />
      </div>
