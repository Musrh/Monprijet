...
app.post("/create-paypal-order", async (req, res) => {
  try {
    ...
    request.requestBody({
      ...
      application_context: {
        return_url: process.env.PAYPAL_RETURN_URL, // ex: https://wellshoppings.com/#/paypal-success
        cancel_url: process.env.PAYPAL_CANCEL_URL, // ex: https://wellshoppings.com/#/cancel
    ...
    // Renvoi URL au frontend (comme Stripe session.url)
