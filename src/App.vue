  ...
  <div class="min-h-screen">
    ...
    <nav class="bg-gray-800 p-4 flex flex-wrap items-center justify-between">
      ...
      <div class="flex flex-wrap items-center space-x-2">
        ...
        <router-link to="/contact" class="bg-green-600 text-white px-4 py-2 rounded font-medium hover:bg-green-700 transition">
          Contact
        </router-link>
        <router-link to="/produits" class="bg-green-600 text-white px-4 py-2 rounded font-medium hover:bg-green-700 transition">
          Produits
        </router-link>

        <!-- Admin Dropdown -->
        <div v-if="isAdmin" class="relative" @mouseenter="adminDropdown=true" @mouseleave="adminDropdown=false">
          <button class="bg-green-600 text-white px-4 py-2 rounded font-medium flex items-center gap-1 hover:bg-green-700 transition">
            Admin
